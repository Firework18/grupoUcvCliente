...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errores)) {
        ...
        $query = "INSERT INTO comentarios (tema_id, mensaje, usuario_id) VALUES ('$tema_id','$mensaje','$usuario');";
        ...
        <div class="row pt-5">
            <div class="col-lg-8">
                ...
                <?php foreach ($errores as $error) : ?>
                    ...
                    <form method="POST" action="foroDetalle.php?resultado=<?php echo $tema_id ?>">
